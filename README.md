...
- **Software Engineers:** Assess your own code for vulnerabilities before it reaches production or operational systems.
- **Independent Developers and Hobbyists:** Verify the safety of code generated by AI assistants or community contributions.
...
- The most recent OSSF scorecard Docker image
...
2. Run the _setup_ PowerShell script from the root directory to create a virtual environment, install dependencies, and activate it:

   ```
   ./scripts/setup.ps1
   ```

3. Create a _.env_ file in the root directory and populate with:
...
<br>
The CSV file generated by a successful run is ready to consume in a tool like Microsoft Excel, see Figure 1. The key columns for decision making are the _Severity_ and _Details_ which together describe a given vulnerability.
