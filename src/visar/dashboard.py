...
re-scanning required. The generated file is named visar_dashboard.html.

Usage:
    python -m visar.dashboard                     # uses project data/ folder
    python -m visar.dashboard <path-to-data-dir>  # explicit directory

    For help:
        python -m visar.dashboard -h
        python -m visar.dashboard --help
"""
...
from .helpers import dashboard_funcs as dash

# initialize logger
logger = setup_logger(__name__)

# default data directory is data/ in the project root, one level above src/
_DEFAULT_DATA_DIR: Path = Path(__file__).resolve().parent.parent.parent / "data"
